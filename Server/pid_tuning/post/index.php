<?php
    ...
    $query = "UPDATE pid_tuning
        SET kp_pitch = '$kp_pitch', ki_pitch = '$ki_pitch', kd_pitch = '$kd_pitch', kp_roll = '$kp_roll', ki_roll = '$ki_roll', kd_roll = '$kd_roll', kp_yaw = '$kp_yaw', ki_yaw = '$ki_yaw', kd_yaw = '$kd_yaw', update_time = now()
        WHERE id = '1'";
