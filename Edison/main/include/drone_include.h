...
#define PWM_DEFAULT_MIN_PWM0 0.000025*4
#define PWM_DEFAULT_MIN_PWM1 0.000025*4
#define PWM_DEFAULT_MIN_PWM2 0.000025*4
#define PWM_DEFAULT_MIN_PWM3 0.000025*4
/**
 * struct drone
 */
struct T_drone{
...
int update_T_drone_arrd_pid(struct T_drone *pT_drone){
    ...
    samplePeriodMs = 40; //need to be setup
...
#endif
		usleep(40000); // We need to add some delay to slow down the pid loop. Mainly, 100ms cycle should be good. 
    }
    /**
     * free pointer
     */
