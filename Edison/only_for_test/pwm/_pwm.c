...
int main()
{
	...
	double arrd_current_duty[3];
	uint8_t arri_i2c_output[4] = { 0, 0 };
    ...
    while(1)
    {
      ...
      /*g_T_drone_self.arrd_current_pwm[0] = g_T_drone_self.arrd_current_pwm[0] / 10;
		...
		arrd_current_duty[0] = g_T_drone_self.arrd_current_pwm[0] / 100 * 40000;
		arrd_current_duty[1] = g_T_drone_self.arrd_current_pwm[1] / 100 * 40000;
		arrd_current_duty[2] = g_T_drone_self.arrd_current_pwm[2] / 100 * 40000;
		arrd_current_duty[3] = g_T_drone_self.arrd_current_pwm[3] / 100 * 40000;
